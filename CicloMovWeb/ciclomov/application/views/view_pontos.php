    ...
    <div class="d-flex justify-content-center flex-wrap gap-4">
        ...
        <?php foreach($pontos as $registro) { ?>
            ...
            <div class="card" style="width: 16rem; margin-top: 30px; border-radius: 10px;" id="<?php echo $registro['cod']; ?>">
                ...
                <buttom onclick="get_id(this.id,<?php $_SESSION('user');?>)" class="btn AreaSelecaoPonto disabled" style="padding-left: auto; padding-right: auto;" id="<?php echo $registro['cod']; ?>" data-mdb-toggle="modal" data-mdb-target="#exampleCentralModal4">
