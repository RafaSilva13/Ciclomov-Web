...
namespace CicloMov
{
    public partial class frm_listarClientes : Form
    {
        ...
        //{
            ...
            //            UpdateStars(DataGridViewRow row)
            //            {

            //                row.Cells["col_codigo"].Value = myReader.GetString(0);
            //                row.Cells["col_usuario"].Value = myReader.GetString(5);
            //                row.Cells["col_email"].Value = myReader.GetString(2);
            //                row.Cells["col_cpf"].Value = myReader.GetString(3);
            //                row.Cells["col_tempo"].Value = myReader.GetString(4);
